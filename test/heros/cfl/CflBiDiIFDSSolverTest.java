...
import heros.cfl.utilities.CflTestHelper.TabulationProblemExchange;
...
import static heros.cfl.utilities.CflTestHelper.*;



@RunWith(Parameterized.class)
public class CflBiDiIFDSSolverTest {

	private CflTestHelper forwardHelper;
	private CflTestHelper backwardHelper;
	private TabulationProblemExchange exchange;
	
	public CflBiDiIFDSSolverTest(TabulationProblemExchange exchange) {
		this.exchange = exchange;
		forwardHelper = new CflTestHelper();
		backwardHelper = new CflTestHelper();
	}
