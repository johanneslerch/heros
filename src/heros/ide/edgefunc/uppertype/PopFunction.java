...
public class PopFunction<T extends Type<T>> extends ChainableEdgeFunction<T> {

	public PopFunction(AbstractFactory<T> factory, ChainableEdgeFunction<T> chainedFunction) {
