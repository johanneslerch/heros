 ...
 *            {@link SootMethod}.
 */
public interface FlowFunctions<N, D, M, Value> {
	 ...
	 */
	public FlowFunction<D, Value> getNormalFlowFunction(N curr, N succ);
	 ...
	 */
	public FlowFunction<D, Value> getCallFlowFunction(N callStmt, M destinationMethod);
	 ...
	 * @return
	 */
	public FlowFunction<D, Value> getReturnFlowFunction(N callSite, M calleeMethod, N exitStmt, N returnSite);
	 ...
	 *            exception handler.
	 */
	public FlowFunction<D, Value> getCallToReturnFlowFunction(N callSite, N returnSite);
